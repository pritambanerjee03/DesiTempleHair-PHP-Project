...
if(isset($_REQUEST['categoryId']) && $_REQUEST['categoryId']!=''){
    $categoryId = base64_decode($_REQUEST['categoryId']);
}else{
    header('Location:'.APP_URL);
    exit;
}
$categoryData = $products->getCategoryDetailsById($categoryId);
        ...
        <!-- <ol class="carousel-indicators indication">
          ...
          <div class="carousel-inner topimage" role="listbox">
            <div class="item active">
                <a href="http://www.beautymineral.in/subCatProducts.php?categoryId=Ng==">
...
<section class="hblock anim-block skincare">
    ...
    <div class="cantainer skincarebundles">
        <h3 class="hb-head"><?=$categoryData->categoryName?></h3>
        <div class="hb-inner fprod clearfix">
            
                <?php $products->getProductsByCategory($categoryId, NULL); ?>
