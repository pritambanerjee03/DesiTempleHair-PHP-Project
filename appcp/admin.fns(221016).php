                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="15%">Distributer Price</th>
    ...
    function addNewProduct(){
        ...
        <script type="text/javascript">
            ...
            $('#addMoreCostsPerWeightElement').click(function(){
                ...
                newTBDiv.innerHTML+="<input type='number' min='1' class='form-control' step='0.01' name='productWeight[]' value='' style='width:25% !important; display:inline !important' placeholder='Weight/Qty' required>&nbsp;<select class='form-control' name='productUnit[]' style='width:15% !important; display:inline !important' required ><option value=''>-Unit-</option><? foreach($weightUnits as $weightUnit){ ?><option value='<?=$weightUnit['attributeValue']?>'><?=$weightUnit['attributeValue']?></option><? } ?></select>&nbsp;<input type='number' min='1' class='form-control' name='productCost[]' value='' style='width:10% !important; display:inline !important' id='productCost_"+costPerWtVal+"' placeholder='Cost' required>&nbsp;<input type='number' min='1' class='form-control' name='productStock[]' value='' style='width:10% !important; display:inline !important' placeholder='Stock' required>&nbsp;<input type='text' class='form-control expiryDate' name='expiryDate[]' value='' style='width:12% !important; display:inline !important' placeholder='Expiry Date' readonly>&nbsp;&nbsp;<input type='text' class='form-control productOffer' name='productOffer[]'' id='productOffer_"+costPerWtVal+"' value='' pattern='[0-9]*' style='width:10% !important; display:inline !important' placeholder='Offer'>&nbsp;<input type='number' min='1' class='form-control' step='0.01' name='productMRP[]' value='' style='width:10% !important; display:inline !important' id='productMRP_"+costPerWtVal+"' placeholder='MRP' required><br/><br/>";
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="" name="product_form" id="addProductForm" method="post" role="form" enctype="multipart/form-data" >            
                                        ...
                                        <div class="form-group">
                                            <p class="Title"><label style="width:26% !important; display:inline-block !important">Weight/Qty</label><label style='width:16% !important; display:inline-block !important'>Unit</label><label style='width:10% !important; display:inline-block !important'>Cost</label><label style="width:10% !important; display:inline-block !important">Stock Date</label><label style="width:12% !important; display:inline-block !important">Expiry Date</label>
                                            <label style='width:10% !important; display:inline-block !important'>Offer %</label><label style='width:10% !important; display:inline-block !important'>MRP</label></p>
                                            ...
                                            <input type="number" min="1" class="form-control" name="productCost[]" id="productCost_0" value="" style="width:10% !important; display:inline !important" placeholder="Cost" required>   
                                            <input type="number" min="0" class="form-control" name="productStock[]" value="" style="width:10% !important; display:inline !important" placeholder="Stock" required>
                                             <input type="text" class="form-control expiryDate" name="expiryDate[]" value="" style="width:12% !important; display:inline !important" placeholder="Expiry Date">   
                                            <input type="text" class="form-control productOffer" name="productOffer[]" id="productOffer_0" value="" pattern='[0-9]*' style="width:10% !important; display:inline !important" placeholder="Offer">   
                                            <input type="number" min="1" class="form-control" step='0.01' name="productMRP[]"  id="productMRP_0" value="" style="width:10% !important; display:inline !important" placeholder="MRP">
        ...
        <script type="text/javascript">
            $( document ).ready(function() {
                ...
                $('#addMoreCostsPerWeightElement').click(function(){
                    ...
                    var descriptionId = content+costPerWtVal;
                    newTBDiv.setAttribute("id",descriptionId);
                    newTBDiv.innerHTML+="<input type='number' min='1' class='form-control' step='0.01' name='productWeight[]' value='' style='width:25% !important; display:inline !important' placeholder='Weight/Qty' required>&nbsp;<select class='form-control' name='productUnit[]' style='width:15% !important; display:inline !important' required ><option value=''>-Unit-</option><? foreach($weightUnits as $weightUnit){ ?><option value='<?=$weightUnit['attributeValue']?>'><?=$weightUnit['attributeValue']?></option><? } ?></select>&nbsp;<input type='number' min='1' class='form-control' name='productCost[]' id='productCost_"+costPerWtVal+"' value='' style='width:10% !important; display:inline !important' placeholder='Cost' required>&nbsp;<input type='number' min='1' class='form-control' name='productStock[]' value='' style='width:10% !important; display:inline !important' placeholder='Stock' required>&nbsp;<input type='text' class='form-control expiryDate' name='expiryDate[]' value='' style='width:12% !important; display:inline !important' placeholder='Expiry Date' readonly>&nbsp;<input type='text' class='form-control productOffer' name='productOffer[]' id='productOffer_"+costPerWtVal+"' value='' pattern='[0-9]*' style='width:10% !important; display:inline !important' placeholder='Offer'>&nbsp;<input type='number' min='1' class='form-control' step='0.01' name='productMRP[]' id='productMRP_"+costPerWtVal+"' value='' style='width:10% !important; display:inline !important' placeholder='MRP' required><br/><br/>";
                    contentID.appendChild(newTBDiv);
            ...
            $('#editProductForm').on('submit', function(e){
                var costPerWtVal = parseInt($('#costPerWtCount').val()) - parseInt(1);
                for(var i=0; i <= costPerWtVal; i++){
                    cost = $('#productCost_'+i).val();
                    mrp = $('#productMRP_'+i).val();
                    offer = $('#productOffer_'+i).val();
                                ...
                                <div class="col-lg-12">
                                    <form action="" name="product_form" id="editProductForm" method="post" role="form" enctype="multipart/form-data" >            
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                             <input type="hidden" name="productDistributerPrice[]" value="<?=$productOption['productDistributerPrice']?>" />
                                            ...
                                            <input type="number" min="1" class="form-control" name="productCost[]" id="productCost_<?=$i?>" value="<?=$productOption['productCost']?>" style="width:10% !important; display:inline !important" placeholder="Cost" required>   
                                            <input type="number" min="0" class="form-control" name="productStock[]" value="<?=$productOption['productStock']?>" style="width:10% !important; display:inline !important" placeholder="Stock" required>   
                                            ...
                                            ?>
                                            <input type="text" class="form-control expiryDate" name="expiryDate[]" value="<?=$expiryDate?>" style="width:12% !important; display:inline !important" placeholder="Expiry Date" readonly>   
                                            <input type="text" class="form-control productOffer" name="productOffer[]" id="productOffer_<?=$i?>" value="<?=$productOption['productOffer']?>" pattern="[0-9]*" style="width:10% !important; display:inline !important" placeholder="Offer">
                                            <input type="number" step='0.01' min="1" class="form-control" name="productMRP[]" id="productMRP_<?=$i?>" value="<?=$productOption['productMRP']?>" style="width:10% !important; display:inline !important" placeholder="MRP" required>   
...
<?php }
   ...
   <?php } 
    ...
    function viewOrderDetail($orderId){
        ...
        $orderDetails = $db->get_row("SELECT id, userId, invoiceNumber, fullName, mobileNumber, email, address, note, subTotal, deliveryCost, totalAmount, orderStatus, dateTime,invoiceNo,paymentType,onlinePaymentStatus,netProfit,offerAmt,foundUsOn,couponDiscount FROM ".ORDER_DETAILS." WHERE id='".$orderId."'", true);
// pre($orderDetails);
            ...
            <div style="margin-bottom:15px;">
                <h2 style="margin-bottom: 5px;padding-bottom: 5px;font-weight:normal;font-size:20px;color:#00A1E2;">
                    ...
                    <div style="margin:0;float:right;color:#000000;">
                         <p><span style="color:#00A1E2;">Invoice No :</span> <?=$orderDetails->invoiceNo?></p>
        ...
        <td colspan="3" style="padding:0 15px;">
            ...
            <table border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;width:100%;text-align:center;border-color:#e5e5e5;">
                ...
                <tr>
                    ...
                    <td style="padding:5px;border-color:#e5e5e5;font-size:14px;"><?=$record['productName']?> (<?=$record['productWeight']?> <?=$record['productUnit']?>) <?php if($productCategoryId->categoryId == '65'){ echo " - ".$productCategoryId->productDescription; } ?></td>
...
function editOrderDetail($orderId){
        ...
        $orderDetails = $db->get_row("SELECT id, userId, invoiceNumber, fullName, mobileNumber, email, address, note, subTotal, deliveryCost, totalAmount, orderStatus, dateTime,invoiceNo,offerAmt,couponDiscount,supportComment FROM ".ORDER_DETAILS." WHERE id='".$orderId."'", true);
// pre($orderDetails);
        $records = $db->get_results("SELECT * FROM ".ORDER_ITEMS." WHERE orderId='".$orderId."' AND active = '1'");
         $update = array(
            'viewOrders' => '1'
    ...
    function getOrderReport(){
         ...
         if($duration == 'currentdate'){
             ...
             if($dateTime < '2016-07-21'){
                $query = "SELECT invoiceNo,fullName,totalAmount,offerAmt,couponDiscount,orderStatus,paymentType,deliveryDate,dateTime FROM ".ORDER_DETAILS." WHERE orderStatus = 'Delivered' AND dateTime LIKE '".$dateTime."%'";
             }else{
                $query = "SELECT invoiceNo,fullName,totalAmount,offerAmt,couponDiscount,orderStatus,paymentType,deliveryDate,dateTime FROM ".ORDER_DETAILS." WHERE orderStatus = 'Delivered' AND deliveryDate LIKE '".$dateTime."%'";
             }
            ...
            if($dateTime < '2016-07-21'){
             $query = "SELECT invoiceNo,fullName,totalAmount,offerAmt,couponDiscount,orderStatus,paymentType,deliveryDate,dateTime FROM ".ORDER_DETAILS." WHERE orderStatus = 'Delivered' AND dateTime BETWEEN '".$lastMonthDate."%' AND '".$today."%'";
            }else{
             $query = "SELECT invoiceNo,fullName,totalAmount,offerAmt,couponDiscount,orderStatus,paymentType,deliveryDate,dateTime FROM ".ORDER_DETAILS." WHERE orderStatus = 'Delivered' AND deliveryDate BETWEEN '".$lastMonthDate."%' AND '".$today."%'";   
            }
         }
           $results = $db->get_results($query);
           if(count($results)>0){
