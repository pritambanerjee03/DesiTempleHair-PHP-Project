...
class PHPMailer {
   ...
   * @var string
   */
  public $Host        = 'smtp.mandrillapp.com';//smtp.sendgrid.net
   ...
   * @var string
   */
  public $Username     = 'sandesh@evol.co.in';//deekshith@evol.co.in

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = 'd-Rx582DhCm4--q5-NO0zg';//sdh47%8vHg
