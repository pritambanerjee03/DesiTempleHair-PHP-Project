            ...
            bz: function M(K) {
                ...
                K.on('themeSpace', function P(N) {
                    if (N.data.space == 'mainMiddle') {
                        var O = '';
                        if (!g) O = u[0] + u[3];
                        N.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content1' style='visibility: hidden;'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + O + '</div>';
                    }
                });
    ...
    (function() {
        m.add('tools', {
            ...
            addTool: function(p, q) {
                ...
                p = q ? '<div id="' + r + '" class="view tool_panel" tabindex="0" style="display: none; visibility: hidden;">' + p + '</div>' : '<div id="' + r + '" class="tool" style="display: none;visibility: hidden;">' + p + '</div>';
        ...
        return {
            dQ: function(p) {
                ...
                var t = p.oW('themeSpace', {
                    ...
                    A = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html lang="' + p.lang.LangCode + '" dir="' + p.lang.dir + '">' + '<head>' + '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />' + t.html + '</head>' + '<body>' + (f.ie6Compat ? '<div id="ckfinder" role="application">' : '<div id="ckfinder" role="application" style="visibility: hidden">') + '<!-- 1. CKE Skin class. -->' + '<div class="fake_wrapper cke_skin_' + z + '">' + '<!-- 2. High contrast class. -->' + '<div class="fake_wrapper"><!-- Applicable: hc cke_hc -->' + '<!-- 3. Browser class. -->' + '<div class="fake_wrapper ' + f.cssClass + '">' + '<!-- 4. RTL class. -->' + '<div class="fake_wrapper cke_' + (p.lang.dir == 'ltr' || g && f.version < 8 ? 'ltr' : 'rtl') + '"><!-- Applicable: rtl cke_rtl -->' + '<!-- 5. Layout class. -->' + '<div class="fake_wrapper">' + '<div id="ckfinder_view" class="columns_2"><!-- Applicable: columns_1 columns_2 -->' + '<div id="sidebar_container" class="container" role="region"' + (p.config.sidebarWidth ? ' style="width: ' + i.cssLength(p.config.sidebarWidth) + '"' : 'style="display: none;"') + '>' + '<div id="sidebar_wrapper" class="wrapper">' + u.html + '</div>' + '</div>' + '<div id="main_container" class="container" role="region">' + v.html + w.html + x.html + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</body>' + '</html>';
