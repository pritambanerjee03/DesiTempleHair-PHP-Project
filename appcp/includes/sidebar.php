    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
           ...
           <!--  <li>
            ...
            <li>
                <a href="#"><i class="fa fa-files-o fa-fw"></i>Attributes<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?=APP_URL?>/index.php?page=manageAttributes">Manage Attributes</a>
                    </li>
                    <li>
                        <a href="<?=APP_URL?>/index.php?page=addNewAttributes">Add New Attributes</a>
                    </li>
                    <li>
                        <a href="<?=APP_URL?>/index.php?page=manageAttributeValues">Manage Attribute Values</a>
                    </li>
                    <li>
                        <a href="<?=APP_URL?>/index.php?page=addNewAttributeValues">Add New Attribute Values</a>
                    </li>
                </ul>
