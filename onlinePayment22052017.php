...
if($_SERVER['HTTP_HOST']=='localhost'){
  $posted['surl'] = 'http://localhost/beauty-mineral/success.php';
}else{
  $posted['surl'] = 'http://www.beautymineral.in/success.php';
}
if($_SERVER['HTTP_HOST']=='localhost'){
  $posted['furl'] = 'http://localhost/beauty-mineral/failure.php';
}else{
  $posted['furl'] = 'http://www.beautymineral.in/failure.php';
}

$posted['productinfo'] = 'Beauty-Mineral';
...
$posted['firstname'] = cleanName($billingDetail->first_name);
$posted['phone'] = cleanNumber($billingDetail->phone);
